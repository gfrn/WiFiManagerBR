/**
 * strings_br.h
 * brazilian portuguese strings for
...
const char HTTP_FORM_WIFI[]        PROGMEM = "<label for='s'>SSID</label><input id='s' name='s' maxlength='32' autocorrect='off' autocapitalize='none' placeholder='{v}'><br/><label for='p'>Senha</label><input id='p' name='p' maxlength='64' type='password' placeholder='{p}'>";
...
const char HTTP_SAVED[]            PROGMEM = "<div class='msg'>Armazenando credenciais<br/>Tentando conectar ESP à rede.<br />Se falhar, reconecte e tente de novo</div>";
...
const char HTTP_STATUS_ON[]        PROGMEM = "<div class='msg S'><strong>Conectado</strong> to {v}<br/><em><small>with IP {i}</small></em></div>";
...
const char HTTP_HELP[]             PROGMEM =
 ...
 "<td>Mostra resultados do scan WiFi e configuração WiFi.(/0wifi noscan)</td></tr>"
 "<tr><td><a href='/wifisave'>/wifisave</a></td>"
 "<td>Guarda configuração WiFi e configura o dispositivo. Variáveis devem ser fornecidas.</td></tr>"
 ...
 "<td>Fecha o popup captiveportal,configportal continua ativo</td></tr>"
 "<tr><td>/exit</td>"
 "<td>Sai do portal de configuração, configportal será fechado</td></tr>"
 "<tr><td>/restart</td>"
 "<td>Reinicia o dispositivo</td></tr>"
 "<tr><td>/erase</td>"
 "<td>Apaga configurações WiFi e reinicia o dispositivo. O dispositivo não vai se conectar à rede até ser reconfigurado.</td></tr>"
 "</table>"
 "<p/>Mais informações sobre o WiFiManager em <a href='https://github.com/tzapu/WiFiManager'>https://github.com/tzapu/WiFiManager</a>.";
#else
const char HTTP_HELP[]             PROGMEM = "";
#endif

const char HTTP_UPDATE[] PROGMEM = "Carregar novo firmware<br/><form method='POST' action='u' enctype='multipart/form-data' onchange=\"(function(el){document.getElementById('uploadbin').style.display = el.value=='' ? 'none' : 'initial';})(this)\"><input type='file' name='update' accept='.bin,application/octet-stream'><button id='uploadbin' type='submit' class='h D'>Carregar</button></form><small><a href='http://192.168.4.1/update' target='_blank'>* Talvez não funcione dentro do captive portal, abra http://192.168.4.1 no navegador.</a><small>";
const char HTTP_UPDATE_FAIL[] PROGMEM = "<div class='msg D'><strong>Atualização malsucedida!</strong><Br/>Reinicie o dispositivo e tente novamente</div>";
const char HTTP_UPDATE_SUCCESS[] PROGMEM = "<div class='msg S'><strong>Atualização bem sucedida.  </strong> <br/> Dispositivo reiniciando...</div>";
...
// Info html
	...
	const char HTTP_INFO_bootver[]    PROGMEM = "<dt>Versão de Boot</dt><dd>{1}</dd>";
	const char HTTP_INFO_lastreset[]  PROGMEM = "<dt>Última razão de reset</dt><dd>{1}</dd>";
	const char HTTP_INFO_flashsize[]  PROGMEM = "<dt>Tamanho de Flash Reale</dt><dd>{1} bytes</dd>";
#endif

const char HTTP_INFO_memsmeter[]  PROGMEM = "<br/><progress value='{1}' max='{2}'></progress></dd>";
const char HTTP_INFO_memsketch[]  PROGMEM = "<dt>Memória - Tamanho do Projeto</dt><dd>Usado / Bytes totais<br/>{1} / {2}";
const char HTTP_INFO_freeheap[]   PROGMEM = "<dt>Memória - Free Heap</dt><dd>{1} bytes disponíveis</dd>"; 
...
const char S_subnet[]             PROGMEM = "Subrede";
const char S_exiting[]            PROGMEM = "Exiting";
const char S_resetting[]          PROGMEM = "Módulo vai reiniciar em alguns segundos.";
const char S_closing[]            PROGMEM = "Você pode fechar a página, o portal vai continuar funcionando";
